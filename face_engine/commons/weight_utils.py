...
from face_engine.commons import folder_utils, package_utils
from face_engine.commons.logger import Logger
from face_engine.modules.exceptions import UnimplementedError
...
def download_all_models_in_one_shot() -> None:
    ...
    from face_engine.models.facial_recognition.VGGFace import WEIGHTS_URL as VGGFACE_WEIGHTS
    from face_engine.models.facial_recognition.Facenet import FACENET128_WEIGHTS, FACENET512_WEIGHTS
    from face_engine.models.facial_recognition.OpenFace import WEIGHTS_URL as OPENFACE_WEIGHTS
    from face_engine.models.facial_recognition.FbDeepFace import WEIGHTS_URL as FBDEEPFACE_WEIGHTS
    from face_engine.models.facial_recognition.ArcFace import WEIGHTS_URL as ARCFACE_WEIGHTS
    from face_engine.models.facial_recognition.DeepID import WEIGHTS_URL as DEEPID_WEIGHTS
    from face_engine.models.facial_recognition.SFace import WEIGHTS_URL as SFACE_WEIGHTS
    from face_engine.models.facial_recognition.GhostFaceNet import WEIGHTS_URL as GHOSTFACENET_WEIGHTS
    from face_engine.models.facial_recognition.Dlib import WEIGHT_URL as DLIB_FR_WEIGHTS
    from face_engine.models.demography.Age import WEIGHTS_URL as AGE_WEIGHTS
    from face_engine.models.demography.Gender import WEIGHTS_URL as GENDER_WEIGHTS
    from face_engine.models.demography.Race import WEIGHTS_URL as RACE_WEIGHTS
    from face_engine.models.demography.Emotion import WEIGHTS_URL as EMOTION_WEIGHTS
    from face_engine.models.spoofing.FasNet import (
        FIRST_WEIGHTS_URL as FASNET_1ST_WEIGHTS,
        SECOND_WEIGHTS_URL as FASNET_2ND_WEIGHTS,
    )
    from face_engine.models.face_detection.Ssd import (
        MODEL_URL as SSD_MODEL,
        WEIGHTS_URL as SSD_WEIGHTS,
    )
    from face_engine.models.face_detection.Yolo import YoloModel
    from face_engine.models.face_detection.YuNet import WEIGHTS_URL as YUNET_WEIGHTS
    from face_engine.models.face_detection.Dlib import WEIGHTS_URL as DLIB_FD_WEIGHTS
    from face_engine.models.face_detection.CenterFace import WEIGHTS_URL as CENTERFACE_WEIGHTS
