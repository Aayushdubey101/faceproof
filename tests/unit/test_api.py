...
from face_engine.api.src.app import create_app
from face_engine.api.src.modules.core import routes
from face_engine.commons.logger import Logger
from face_engine.modules.detection import extract_faces, DetectedFace, FacialAreaRegion
from face_engine.modules import detection
...
class TestApiFunctions(unittest.TestCase):
    ...
    def test_extract_image_from_form_data(self):
        ...
        with DUMMY_APP.test_request_context("/dummy_endpoint"):
            # Mock the file part
            with patch("face_engine.api.src.modules.core.routes.request") as mock_request:
                mock_file = MagicMock()
                ...
                with patch(
                    "face_engine.commons.image_utils.load_image_from_file_storage",
...
class TestTokenValidation(unittest.TestCase):
    ...
    @patch("face_engine.api.src.modules.core.service.build_index")
    @patch("face_engine.api.src.modules.core.service.search")
    @patch("face_engine.api.src.modules.core.service.register")
    @patch("face_engine.api.src.modules.core.service.represent")
    @patch("face_engine.api.src.modules.core.service.analyze")
    @patch("face_engine.api.src.modules.core.service.verify")
...
class TestConnectionStringSucceddedValidation(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher_register = patch("face_engine.api.src.modules.core.service.register")
        self.patcher_search = patch("face_engine.api.src.modules.core.service.search")
        self.patcher_build_index = patch("face_engine.api.src.modules.core.service.build_index")
