import numpy as np
import pytest
from face_engine.modules.detection import extract_faces, DetectedFace, FacialAreaRegion, is_valid_landmark
...
def test_extract_faces_sanitizes_landmarks(monkeypatch):
    ...
    monkeypatch.setattr("face_engine.modules.detection.detect_faces", lambda *args, **kwargs: [detected_face])
