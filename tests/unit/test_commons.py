...
from face_engine.commons import folder_utils, weight_utils, package_utils
...
@mock.patch("face_engine.commons.folder_utils.get_deepface_home")  # Update with your actual module
